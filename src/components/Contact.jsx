...
function Contact() {
    const whatsappLink = 'https://wa.me/918982276125?text=Hi%20Piyush%2C%20I%20want%20to%20discuss%20a%20website%20project.';
                        ...
                        <div className="info-item">
                            ...
                            <div className="social-links">
                                ...
                                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="social-link">
                                    <svg viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M20.52 3.48A11.86 11.86 0 0012.06 0C5.57 0 .3 5.27.3 11.76c0 2.07.54 4.1 1.57 5.89L0 24l6.55-1.82a11.7 11.7 0 005.51 1.4h.01c6.49 0 11.76-5.27 11.76-11.76 0-3.14-1.22-6.09-3.31-8.34zM12.07 21.6h-.01a9.8 9.8 0 01-4.99-1.36l-.36-.21-3.89 1.08 1.04-3.79-.24-.39a9.78 9.78 0 01-1.5-5.17c0-5.42 4.41-9.83 9.84-9.83 2.62 0 5.09 1.02 6.94 2.88a9.78 9.78 0 012.9 6.95c0 5.42-4.42 9.84-9.83 9.84zm5.4-7.36c-.3-.15-1.77-.87-2.05-.97-.27-.1-.47-.15-.67.15s-.77.97-.94 1.17c-.17.2-.35.22-.64.07-.3-.15-1.25-.46-2.38-1.47-.88-.79-1.47-1.76-1.64-2.06-.17-.3-.02-.46.13-.6.14-.14.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.48-.5-.67-.5h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.5s1.07 2.9 1.22 3.1c.15.2 2.1 3.2 5.1 4.49.71.31 1.27.49 1.7.63.71.22 1.36.19 1.87.12.57-.08 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.12-.27-.2-.57-.35z" />
                                    </svg>
                                    WhatsApp
                                </a>
                            </div>
