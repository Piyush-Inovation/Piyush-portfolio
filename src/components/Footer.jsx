...
function Footer() {
  ...
  const handleScrollToSection = (sectionId, path = '/') => {
      ...
      <motion.div className="footer-content" variants={containerVariants}>
        ...
        <motion.div className="footer-top" variants={itemVariants}>
          <div className="footer-links">
            ...
            <a 
              ...
              onClick={() => handleScrollToSection('about-me', '/image-slider')}
            ...
            <a 
              className="footer-link" 
              onClick={() => handleScrollToSection('tech-stack', '/image-slider')}
              style={{ cursor: 'pointer' }}
            >
              Tech Stack
            </a>
            <a 
              className="footer-link" 
              onClick={() => handleScrollToSection('experience', '/image-slider')}
              style={{ cursor: 'pointer' }}
            >
              Experience
            </a>
        ...
        <motion.div className="footer-social" variants={itemVariants}>
          <div className="social-icons-left">
            ...
            <a 
              href="https://github.com/Piyush-Inovation" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="social-icon-link"
              aria-label="GitHub"
